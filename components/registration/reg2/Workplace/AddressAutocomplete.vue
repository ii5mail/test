<template>
    <v-combobox
        ...
        :clearable="!!clearable"
    >
        <!-- <template v-if="!!address_1_only" slot="selection" slot-scope="data">
            {{ data.item.value.split(', ')[0] }}
        </template> -->
        <!-- <span v-if="!!address_1_only">
...
<script>
    import { get_addresses } from "./utils"
